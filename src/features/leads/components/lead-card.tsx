...
export function LeadCard({ lead, onClick }: LeadCardProps) {
	...
	return (
		<Card
			...
			className="cursor-pointer border-border bg-white transition-all duration-200 hover:-translate-y-0.5 hover:border-primary/40 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 dark:bg-slate-900"
		>
