...
/**
 * Skeleton para carga del formulario de empresa (crear/editar)
 * Refleja la estructura exacta del EmpresaForm
 */
export function EmpresaFormSkeleton() {
	return (
...
/**
 * Skeleton específico para edición de empresa
 * Estructura idéntica al componente real: max-w-2xl mx-auto > space-y-6 > (header + form)
 */
export function EditEmpresaFormSkeleton() {
	return (
		<div className="max-w-2xl mx-auto">
