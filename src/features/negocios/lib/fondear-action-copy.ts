/** Texto del tooltip para la acción Fondear (negocios sin cuotas anuales). */
export const FONDEAR_ACTION_TOOLTIP =
...
export const FONDEAR_ANNUAL_ACTION_TOOLTIP =
	'Marca las cuotas anuales que quieras fondear en este paso. Podrás repetir hasta completar todas.'
