	...
	(
		...
		if (collapsible === 'none') {
			return (
				<div
					className={cn(
						'flex h-full w-64 flex-col sidebar-custom text-sidebar-foreground',
						className
					)}
					ref={ref}
					{...props}
			...
			return (
				<Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
					<SheetContent
						...
						data-mobile="true"
						className="w-72 sidebar-custom p-0 text-sidebar-foreground [&>button]:hidden"
						side={side}
					>
		...
		return (
			...
			>
				...
				>
					<div
						data-sidebar="sidebar"
						className="flex h-full w-full flex-col sidebar-custom group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow"
					>
						{children}
					</div>
				</div>
...
>(({ className, ...props }, ref) => (
	<ul
		...
		className={cn(
			'mx-3.5 flex min-w-0 translate-x-px flex-col gap-1 px-2.5 py-1.5 ml-4',
			'group-data-[collapsible=icon]:hidden',
			className
		)}
		{...props}
