...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-16 w-full items-center gap-0 rounded-[32px] bg-[#E8E8E8] p-2 text-muted-foreground shadow-inner",
      className
    )}
    {...props}
  />
