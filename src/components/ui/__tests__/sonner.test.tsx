...
describe('Toast/Sonner Component', () => {
  ...
  it('calls toast with action and cancel buttons', () => {
    const TestComponent = () => {
      const handleToastWithActions = () => {
        toast.message('Message with actions', {
      ...
      return (
        <button onClick={handleToastWithActions}>
  ...
  it('calls toast with custom duration', () => {
    const TestComponent = () => {
      const handleCustomDuration = () => {
        toast.message('Custom duration toast', {
          duration: 10000,
        });
      };
      return (
  ...
  it('calls toast with infinite duration', () => {
    const TestComponent = () => {
      const handleInfiniteDuration = () => {
        toast.message('Persistent toast', {
          duration: Infinity,
        });
      };
      return (
        <button onClick={handleInfiniteDuration}>Show Persistent Toast</button>
      );
    };
  ...
  it('calls toast with custom position', () => {
    const TestComponent = () => {
      const handleCustomPosition = () => {
        toast.message('Positioned toast', {
          position: 'top-left',
        });
      };
      return (
        <button onClick={handleCustomPosition}>Show Positioned Toast</button>
      );
    };
  ...
  it('calls toast with rich content', () => {
    const TestComponent = () => {
      const handleRichContent = () => {
        toast.message('Rich content toast', {
          description: (
            <div>
  ...
  it('handles multiple toast calls', () => {
    const TestComponent = () => {
      ...
      return (
        <button onClick={handleMultipleToasts}>Show Multiple Toasts</button>
      );
    };
