...
import { useCommissionRules } from '@/features/commission-rules/hooks/use-commission-rules'
...
export default function CommissionRulesPage() {
	...
	return (
		<div className="space-y-6">
			<div className="flex items-center justify-between">
				<div>
					...
					<p className="text-muted-foreground">
						Administra las reglas de distribución de comisiones para este producto.
					</p>
				</div>
				<Button asChild>
					<Link
						href={`/dashboard/configuraciones-producto/${productConfigId}/reglas/crear`}
					>
			...
			<Card>
				<CardHeader>
					<CardTitle>Reglas Registradas</CardTitle>
					<CardDescription>
						Listado de reglas de comisión activas e inactivas.
					</CardDescription>
				</CardHeader>
