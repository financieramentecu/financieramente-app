...
export default function PeriodicitiesAdminPage() {
  ...
  const [selectedPeriodicity, setSelectedPeriodicity] = useState<Periodicity | null>(null)
  ...
  const fields: CrudModalField[] = [
    ...
    },
    {
      ...
      type: "switch",
      required: false,
      description: "Inactiva la periodicidad para evitar que nuevos registros la utilicen.",
    },
  ]
    ...
    <DashboardLayout currentPage="Periodicidades">
      <div className="space-y-6">
        ...
        <CrudModal
          ...
          title={mode === "create" ? "Crear Periodicidad" : "Editar Periodicidad"}
          description={
            mode === "create"
