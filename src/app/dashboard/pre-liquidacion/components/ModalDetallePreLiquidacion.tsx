										...
										<table className="w-full text-[10px]">
											<thead className="bg-muted sticky top-0">
												<tr>
													...
													<th className="text-center py-2 px-1 font-semibold text-foreground whitespace-nowrap">
														Rezagado
													</th>
													<th className="text-left py-2 px-1 font-semibold text-foreground whitespace-nowrap">
														Cliente
													...
													<th className="text-right py-2 px-1 font-semibold text-foreground whitespace-nowrap">
														Comisión
													</th>
													<th className="text-right py-2 px-1 font-semibold text-info whitespace-nowrap">
														Gen Bruta
													</th>
													<th className="text-right py-2 px-1 font-semibold text-info whitespace-nowrap">
														Gen Desc
													</th>
													<th className="text-right py-2 px-1 font-semibold text-primary whitespace-nowrap">
														Ag Bruta
													</th>
													<th className="text-right py-2 px-1 font-semibold text-primary whitespace-nowrap">
														Ag Desc
													</th>
													<th className="text-right py-2 px-1 font-semibold text-indigo-700 whitespace-nowrap">
														Lid Bruta
													</th>
													<th className="text-right py-2 px-1 font-semibold text-indigo-700 whitespace-nowrap">
														Lid Desc
													</th>
													<th className="text-right py-2 px-1 font-semibold text-pink-700 whitespace-nowrap">
														Co Bruta
													</th>
													<th className="text-right py-2 px-1 font-semibold text-pink-700 whitespace-nowrap">
														Co Desc
											...
											<tbody>
												{data.registros.map((registro) => (
													...
													>
														...
														<td
															className="py-1 px-1 max-w-[100px] truncate"
														...
														<td
															className="py-1 px-1 max-w-[100px] truncate"
															title={registro.nombreCliente || ''}
														>
															{registro.nombreCliente || '-'}
														</td>
														<td className="py-1 px-1">
															{registro.cedulaAgente || '-'}
														</td>
														<td
															className="py-1 px-1 max-w-[100px] truncate"
															title={registro.nombreAgente}
														>
														...
														<td
															className="py-1 px-1 max-w-[80px] truncate"
															title={registro.tipoComision || ''}
														>
										...
										<table className="w-full text-xs">
											<thead className="bg-muted sticky top-0">
												<tr>
													...
													<th className="text-right py-2 px-2 font-semibold text-success">
														Sync
													</th>
													<th className="text-right py-2 px-2 font-semibold text-warning">
														Lag
													</th>
													<th className="text-right py-2 px-2 font-semibold text-info">
														General
													</th>
													<th className="text-right py-2 px-2 font-semibold text-primary">
														Agencia
													</th>
													<th className="text-right py-2 px-2 font-semibold text-indigo-700">
														Líder
													</th>
													<th className="text-right py-2 px-2 font-semibold text-pink-700">
														Coach
													</th>
													<th className="text-right py-2 px-2 font-semibold text-foreground">
														Total
											...
											<tfoot className="bg-muted font-bold">
												<tr>
													...
													<td className="py-2 px-2 text-right text-success">
														{data.distribucion.reduce(
															(s, d) => s + d.sincronizados,
															0
														)}
													</td>
