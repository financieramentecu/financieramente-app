...
export const currencySchema = z.object({
  name: z.string().min(1, "El nombre es obligatorio").max(50, "El nombre no puede exceder 50 caracteres"),
  symbol: z.string().max(5, "El símbolo no puede exceder 5 caracteres").optional(),
