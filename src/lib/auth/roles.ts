...
export const ROLE_DESCRIPTIONS: Record<UserRole, string> = {
  [UserRole.DEFAULT]: 'Rol por defecto asignado a usuarios nuevos pendientes de activación',
  [UserRole.ASISTENTE_GERENCIA_OPERATIVA]: 'Acceso completo al sistema excepto administración',
  [UserRole.ANALISTA_SOPORTE]: 'Acceso limitado a negocios y reportes de negocio',
