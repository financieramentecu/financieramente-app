...
const meta: Meta<typeof DocumentAutocomplete> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Componente de autocomplete para buscar y seleccionar documentos de usuarios existentes o crear uno nuevo. Soporta búsqueda por documento, nombre o apellido.',
      }
    }
  },
  decorators: [
  ...
  return (
    <div className="max-w-md space-y-4">
      ...
      <div className="text-sm text-gray-600">
        <p>Documento seleccionado: <strong>{value || 'Ninguno'}</strong></p>
      </div>
    </div>
  )
}
  ...
  render: () => {
    ...
    return (
      <div className="max-w-md space-y-4">
        ...
        />
        <div className="text-sm text-gray-600">
          <p>Documento seleccionado: <strong>{value}</strong></p>
        </div>
      </div>
    )
  },
