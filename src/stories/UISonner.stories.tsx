...
const meta: Meta = {
	...
	parameters: {
		...
		docs: {
			description: {
				component:
					'Sistema de notificaciones emergentes con diferentes estados y duraciones. Utiliza Sonner para una experiencia moderna y accesible según WCAG AA.',
			},
		},
	},
}
...
export const RichContent: Story = {
	render: () => (
		<Button
			onClick={() =>
				toast('Toast con contenido rico', {
					description: (
						<div className="space-y-2">
