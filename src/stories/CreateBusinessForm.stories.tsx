...
const meta: Meta<typeof CreateBusinessForm> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Formulario para crear un nuevo negocio con validaciones usando Zod. El campo No. Documento ahora incluye autocomplete para buscar usuarios existentes o crear uno nuevo.',
      }
    }
  },
  decorators: [
