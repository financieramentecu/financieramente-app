...
- `ai-specs/specs/frontend-standards.mdc`: Git Workflow (feature branches, descriptive commits, small focused branches).
- `ai-specs/.commands/develop-frontend.md`: Use `gh` for GitHub and PR creation; optional ticket-based branch and PR linking.
