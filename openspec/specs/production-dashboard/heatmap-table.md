# Specification: Production Dashboard — Heatmap Table

## Overview

Per-user × per-company production value heatmap with sticky name column, hierarchy/filter reactivity, and role-based visibility.
...
- Initial specification from dashboard-heatmap-table change
- 9 requirements covering API, service, hook, component, and UI behavior
- Role-based visibility and reactivity to filters/selections
