# Delta for Categories — `preliquidacion-beneficiario-categoria-clawback`
...
(None — existing category create/edit behavior for `code`, `name`, `typeCategory`, `descripcion`, `status` is unchanged.)
