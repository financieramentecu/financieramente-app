...
- [ ] T009 [P] [US1] Add header validation tests in `src/app/dashboard/carga-archivos/lib/__tests__/validate-excel-structure.test.ts`

### Implementation for User Story 1

- [ ] T010 [US1] Update header validation to accept fileType in `src/app/dashboard/carga-archivos/lib/validate-excel-structure.ts`
- [ ] T011 [US1] Update file parsing to require columns by type in `src/app/dashboard/carga-archivos/lib/process-excel-file.ts`
- [ ] T012 [US1] Add file type selector and wire requests in `src/app/dashboard/carga-archivos/components/CargarArchivoTab.tsx`
- [ ] T013 [US1] Require `fileType` in create import API in `src/app/api/carga-archivos/file-import/route.ts`
- [ ] T014 [US1] Accept `fileType` in batch API request shape in `src/app/api/carga-archivos/process-batch/route.ts`
...
- [ ] T015 [P] [US2] Add numeric parsing tests in `src/app/dashboard/carga-archivos/lib/__tests__/number-utils.test.ts`
- [ ] T016 [P] [US2] Add batch processing error/audit tests in `src/app/api/carga-archivos/process-batch/__tests__/route.test.ts`

### Implementation for User Story 2

- [ ] T017 [US2] Apply currency parsing/validation in `src/app/dashboard/carga-archivos/lib/process-excel-file.ts`
- [ ] T018 [US2] Implement mapping by fileType and lag rules in `src/app/api/carga-archivos/process-batch/route.ts`
- [ ] T019 [US2] Add audit logging for invalid numeric values in `src/app/api/carga-archivos/process-batch/route.ts`
- [ ] T020 [US2] Load CommissionConfiguration (or defaults 12%/10%) and store snapshots in `src/app/api/carga-archivos/process-batch/route.ts`
- [ ] T021 [US2] Persist POLIZA-specific fields (`origin_commission`, `clawback_percentage`, `descripcion`) in `src/app/api/carga-archivos/process-batch/route.ts`
...
- [ ] T022 [P] [US3] Update pre-liquidation calculation tests in `src/features/pre-liquidacion/services/pre-liquidacion.service.test.ts`

### Implementation for User Story 3

- [ ] T023 [US3] Update formulas to use base_commission and snapshots in `src/features/pre-liquidacion/services/pre-liquidacion.service.ts`
- [ ] T024 [US3] Use porcentaje_portfolio when `origin_commission = CARTERA` in `src/features/pre-liquidacion/services/pre-liquidacion.service.ts`
- [ ] T025 [US3] Replace `fechaPago` range filter with a supported field (e.g., `createdAt`) in `src/features/pre-liquidacion/services/pre-liquidacion.service.ts`
- [ ] T026 [US3] Update Prisma model usages after commission renames in `src/features/pre-liquidacion/services/pre-liquidacion.service.ts`
...
- [ ] T027 [P] Update docs references in `docs/sync-preliquidacion-flow.md` if needed
