...
-- Agregar columna id_client_origin a product_percentaje_commision (nullable temporalmente)
...
-- Si necesitas mapear valores específicos de product_origin a client_origin, modifica esta consulta
